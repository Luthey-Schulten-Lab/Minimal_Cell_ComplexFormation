...
def initializeConstants(sim_properties):
    ...
    kinetic_params_path =  '../input_data/kinetic_params_JPCB.xlsx'; sim_properties['kinetic_params_path'] = kinetic_params_path
    init_conc_path = '../input_data/initial_concentrations_JPCB.xlsx'; sim_properties['init_conc_path'] = init_conc_path
    ribo_assembly_path = '../input_data/ribo_assembly.xlsx'; sim_properties['ribo_assembly_path'] = ribo_assembly_path
    mRNA_count_path = '../input_data/avg_mRNACount_JPCB.xlsx'; sim_properties['mRNA_count_path'] = mRNA_count_path
    cplx_path = '../input_data/complex_formation_JPCB.xlsx'; sim_properties['cplx_path'] = cplx_path
...
def getTransloconRNCComplex(sim_properties):
    ...
    secretedList = sim_properties['locations_ptns']['secreted']
